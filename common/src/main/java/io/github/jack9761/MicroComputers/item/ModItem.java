...
public class ModItem {
    ...
    public static final RegistrySupplier<Item> SILICON =  ITEMS.register("silicon",() -> new Item(new Item.Properties().arch$tab(ModCreativeMode.MICROCOMPUTERS_CREATIVE_TAB)));
}
