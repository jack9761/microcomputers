...
public class ModBlock {
    ...
    public static RegistrySupplier<Block> MICROCOMPUTER_BLOCK = BLOCKS.register("microcomputer",() -> new MicroComputerBlock(BlockBehaviour.Properties.of().strength(1.5f).noOcclusion()));
}
